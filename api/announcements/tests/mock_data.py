...
__two_days_ago = str(datetime.today().date() + timedelta(days=-2))
...
GET_QUERY_BY_SEARCH_RETURN_DATA = ('/announcements?search=testing', ANNOUNCEMENT_PAYLOAD, 'data')
GET_QUERY_BY_SEARCH_RETURN_NO_DATA = ('/announcements?search=notvalid', ANNOUNCEMENT_PAYLOAD, 'no_data')
GET_QUERY_BY_RECIPIENT_RETURN_DATA = ('/announcements?recipient=teachers', {**ANNOUNCEMENT_PAYLOAD, 'recipient': 'teachers'}, 'data')
GET_QUERY_BY_RECIPIENT_RETURN_NO_DATA = ('/announcements?recipient=teachers', ANNOUNCEMENT_PAYLOAD, 'no_data')
GET_QUERY_BY_TYPE_RETURN_DATA = ('/announcements?type=multi_event', ANNOUNCEMENT_PAYLOAD, 'data')
GET_QUERY_BY_TYPE_RETURN_NO_DATA = ('/announcements?type=multi_event',  {**__SINGLE_EVENT_PAYLOAD}, 'no_data')
GET_QUERY_BY_START_DATE_RETURN_DATA = (f'/announcements?from_date={__yesterday}', ANNOUNCEMENT_PAYLOAD, 'data')
